...
use NFePHP\NFSe\Models\Abrasf\Factories\SignerRps as Signer;
use NFePHP\NFSe\Counties\M3506003\Rps as Rps;
...
class RenderRps extends RenderRPS203
{
    ...
    public static function render($rps, &$dom, &$parent)
    {
        ...
        // $root->setAttribute('Id', "{$rps->infNumero}");
    ...
    public static function appendRps(
        ...
        // $tagDestino = $dom->getElementsByTagName('InfDeclaracaoPrestacaoServico');
        // $tagDestino = $dom->getElementsByTagName('GerarNfseEnvio');
        $tagDestino = null;
